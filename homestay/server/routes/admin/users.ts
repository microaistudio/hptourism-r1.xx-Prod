...
export function createAdminUsersRouter() {
  ...
  // Get all users
  router.get("/users", requireRole("admin", "super_admin", "system_admin"), async (_req, res) => {
    try {
  ...
  // Update user
  router.patch("/users/:id", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
      const { id } = req.params;
      const {
        role,
  ...
  // Toggle user status
  router.patch("/users/:id/status", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
      const { id } = req.params;
  ...
  // Create a new user
  router.post("/users", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
      const {
        mobile,
        fullName,
