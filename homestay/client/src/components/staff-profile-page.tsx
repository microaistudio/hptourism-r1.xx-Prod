...
export default function StaffProfilePage({
  ...
  const onPasswordSubmit = (data: { newPassword: string; confirmPassword: string }) => {
        ...
        <form onSubmit={profileForm.handleSubmit(onProfileSubmit)} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload your digital signature for official documents</CardDescription>
            </CardHeader>
            <CardContent>
              <FormField
                control={profileForm.control}
                    ...
                    <FormControl>
                      <ObjectUploader
                        ...
                        onUploadComplete={(files) => {
                          if (files.length > 0) {
                            field.onChange(files[0].filePath);
                          } else {
                            field.onChange("");
                          }
                        }}
