...
export function createAdminHimkoshRouter() {
  ...
  router.get("/payments/himkosh", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
  ...
  router.put("/payments/himkosh", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
  ...
  router.delete("/payments/himkosh", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
      const existing = await getSystemSettingRecord(HIMKOSH_GATEWAY_SETTING_KEY);
      if (!existing) {
  ...
  router.get("/payments/himkosh/ddo-codes", requireRole("admin", "super_admin", "system_admin"), async (_req, res) => {
    try {
  ...
  router.post("/payments/himkosh/transactions/clear", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
  ...
  router.post("/payments/himkosh/ddo-test", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
