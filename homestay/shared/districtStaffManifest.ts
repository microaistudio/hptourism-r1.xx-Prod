...
const DISTRICT_STAFF_MANIFEST: StaffAccountManifestEntry[] = [
  ...
  // === Group B: Mandi + Bilaspur (Merged Pipeline) ===
  {
    districtLabel: "Mandi",
    ddoCode: "MDI00-532",
    isActive: true, // Receives: Mandi + Bilaspur applications
    da: {
      username: "da_mandi",
      password: "daman@2025",
  ...
  // DORMANT: Bilaspur merged with Mandi per 2025 workflow
  {
    districtLabel: "Bilaspur",
    ddoCode: "BLS00-047",
    isActive: false, // DORMANT - Bilaspur routes to Mandi
    da: {
