...
const buildLocation = (app: Partial<HomestayApplication>) => {
  let displayDistrict = app.district;
  if (app.district?.toLowerCase() === "pangi") {
    displayDistrict = "Chamba";
  } else if (app.district?.toLowerCase()?.includes("kaza") || app.district?.toLowerCase() === "spiti") {
    displayDistrict = "Lahaul and Spiti";
  }
