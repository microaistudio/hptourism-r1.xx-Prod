...
export function ApplicationPipelineRow({ application, actionLabel, applicationIds, hideAction, baseUrl = "/da/applications" }: ApplicationPipelineRowProps) {
  ...
  const targetUrl = `${baseUrl}/${application.id}?queue=${queueParam}`;
