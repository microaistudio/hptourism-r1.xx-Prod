...
export function createAdminCommunicationsRouter() {
  ...
  router.get("/communications", requireRole("admin", "super_admin", "system_admin"), async (_req, res) => {
    try {
  ...
  router.put("/communications/email", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
  ...
  router.put("/communications/sms", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
      const providerInput =
  ...
  router.post("/communications/email/test", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
  ...
  router.post("/communications/sms/test", requireRole("admin", "super_admin", "system_admin"), async (req, res) => {
    try {
