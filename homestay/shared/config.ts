...
const envSchema = z
  .object({
    ...
    HIMKOSH_TEST_AMOUNT: z.coerce.number().optional(),
    ...
    RATE_LIMIT_UPLOAD_MAX_REQUESTS: z.coerce.number().int().positive().default(100), // Increased to 100 for reliable bulk document uploads
