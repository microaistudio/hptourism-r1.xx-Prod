/**
 * ============================================================================
 * @deprecated RETIRED BACKUP FILE
 * This is a backup of the old dashboard. The active dashboard is still in use, 
 * but this backup was taken before major architectural changes.
 * ============================================================================
 */
...
import EconomicImpactCards from "@/components/dashboard/EconomicImpactCards";
...
export default function Dashboard() {
  ...
  // Check if legacy registration is enabled
  const { data: legacySettingData } = useQuery<{ enabled: boolean }>({
    queryKey: ["/api/settings/enable-legacy-registrations"],
    staleTime: 60 * 1000,
  });
  const legacyRegistrationEnabled = legacySettingData?.enabled !== false;
  ...
  return (
    <div className="bg-background p-6">
      ...
      {/* Property Owner View - Standard Dashboard */}
      {!(user.role === 'state_officer' || user.role === 'admin') && (
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              {user.role === 'property_owner' && legacyRegistrationEnabled && (
                <Button
                  variant="secondary"
          ...
          {/* Useful Formats Section - Existing & Prospective Owners Only */}
          {user.role === 'property_owner' && (
            <div className="mb-8">
