                                ...
                                <FormField
                                    ...
                                    render={({ field, fieldState }) => (
                                        <FormItem className="col-span-1">
                                            ...
                                            >
                                                <FormControl>
                                                    <SelectTrigger className={`h-11 ${fieldState.invalid || (showRequiredWarning && (!field.value || !["s_o", "d_o", "w_o", "c_o"].includes((field.value || "").toLowerCase()))) ? "!border-amber-400 !ring-2 !ring-amber-200" : ""}`}>
